...
const GoodPage: FC<Props> = (props: Props) => {
   const { id } = useParams();
  const userId = useSelector<ReducersProps,string>(state=> state.userInfo.user.id)
...
const data= {
  ...
  "goodsTitle":"戴尔（DELL）灵越7590 燃7000酷睿九代15.6英寸轻薄高能合金本游戏设计手提笔记本电脑 i7-9750H GTX1650 4G独显 旗舰版 16G内存 1TB固态硬盘",
  "goodsTwoClassify":4,
  "id":2,
  "isOverseas":0,
  "isVip":0,
