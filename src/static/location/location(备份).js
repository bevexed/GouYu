    ...
    children: [
      {
        ...
        children: [
          ...
          { value: '810110', label: '北区' },
          { value: '810111', label: '大埔区' },
          { value: '810112', label: '沙田区' },
          { value: '810113', label: '西贡区' },
          { value: '810114', label: '荃湾区' },
          { value: '810115', label: '屯门区' },
          { value: '810116', label: '元朗区' },
    ...
    children: [
      {
        ...
        children: [
          ...
          { value: '820107', label: '圣方济各堂区' },
          { value: '820108', label: '路氹城' },
          { value: '820109', label: '澳门新城' },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        label: '台北市',
        children: [
          { label: '中正区', value: '830101' },
          { value: '830102', label: '大同区' },
          { value: '830103', label: '中山区' },
          { value: '830104', label: '万华区' },
          { value: '830105', label: '信义区' },
          { value: '830106', label: '松山区' },
          { value: '830107', label: '大安区' },
          { value: '830108', label: '南港区' },
          { value: '830109', label: '北投区' },
          { value: '830110', label: '内湖区' },
          { value: '830111', label: '士林区' },
          { value: '830112', label: '文山区' },
        ],
      },
      {
        value: '830200',
        label: '新北市',
        children: [
          { label: '板桥区', value: '830201' },
          { value: '830202', label: '土城区' },
          { value: '830203', label: '新庄区' },
          { value: '830204', label: '新店区' },
          { value: '830205', label: '深坑区' },
          { value: '830206', label: '石碇区' },
          { value: '830207', label: '坪林区' },
          { value: '830208', label: '乌来区' },
          { value: '830209', label: '五股区' },
          { value: '830210', label: '八里区' },
          { value: '830211', label: '林口区' },
          { value: '830212', label: '淡水区' },
          { value: '830213', label: '中和区' },
          { value: '830214', label: '永和区' },
          { value: '830215', label: '三重区' },
          { value: '830216', label: '芦洲区' },
          { value: '830217', label: '泰山区' },
          { value: '830218', label: '树林区' },
          { value: '830219', label: '莺歌区' },
          { value: '830220', label: '三峡区' },
          { value: '830221', label: '汐止区' },
          { value: '830222', label: '金山区' },
          { value: '830223', label: '万里区' },
          { value: '830224', label: '三芝区' },
          { value: '830225', label: '石门区' },
          { value: '830226', label: '瑞芳区' },
          { value: '830227', label: '贡寮区' },
          { value: '830228', label: '双溪区' },
          { value: '830229', label: '平溪区' },
        ],
      },
      {
        value: '830300',
        label: '桃园市',
        children: [
          { label: '桃园区', value: '830301' },
          { value: '830302', label: '中坜区' },
          { value: '830303', label: '平镇区' },
          { value: '830304', label: '八德区' },
          { value: '830305', label: '杨梅区' },
          { value: '830306', label: '芦竹区' },
          { value: '830307', label: '大溪区' },
          { value: '830308', label: '龙潭区' },
          { value: '830309', label: '龟山区' },
          { value: '830310', label: '大园区' },
          { value: '830311', label: '观音区' },
          { value: '830312', label: '新屋区' },
      ...
      },
      {
        ...
        label: '台中市',
        children: [
          { label: '中区', value: '830401' },
          { value: '830402', label: '东区' },
          { value: '830403', label: '西区' },
          { value: '830404', label: '南区' },
          { value: '830405', label: '北区' },
          { value: '830406', label: '西屯区' },
          { value: '830407', label: '南屯区' },
          { value: '830408', label: '北屯区' },
          { value: '830409', label: '丰原区' },
          { value: '830410', label: '大里区' },
          { value: '830411', label: '太平区' },
          { value: '830412', label: '东势区' },
          { value: '830413', label: '大甲区' },
          { value: '830414', label: '清水区' },
          { value: '830415', label: '沙鹿区' },
          { value: '830416', label: '梧栖区' },
          { value: '830417', label: '后里区' },
          { value: '830418', label: '神冈区' },
          { value: '830419', label: '潭子区' },
          { value: '830420', label: '大雅区' },
          { value: '830421', label: '新小区' },
          { value: '830422', label: '石冈区' },
          { value: '830423', label: '外埔区' },
          { value: '830424', label: '大安区' },
          { value: '830425', label: '乌日区' },
          { value: '830426', label: '大肚区' },
          { value: '830427', label: '龙井区' },
          { value: '830428', label: '雾峰区' },
          { value: '830429', label: '和平区' },
        ],
      },
      {
        value: '830500',
        label: '台南市',
        children: [
          { label: '中西区', value: '830501' },
          { value: '830502', label: '东区' },
          { value: '830503', label: '南区' },
          { value: '830504', label: '北区' },
          { value: '830505', label: '安平区' },
          { value: '830506', label: '安南区' },
          { value: '830507', label: '永康区' },
          { value: '830508', label: '归仁区' },
          { value: '830509', label: '新化区' },
          { value: '830510', label: '左镇区' },
          { value: '830511', label: '玉井区' },
          { value: '830512', label: '楠西区' },
          { value: '830513', label: '南化区' },
          { value: '830514', label: '仁德区' },
          { value: '830515', label: '关庙区' },
          { value: '830516', label: '龙崎区' },
          { value: '830517', label: '官田区' },
          { value: '830518', label: '麻豆区' },
          { value: '830519', label: '佳里区' },
          { value: '830520', label: '西港区' },
          { value: '830521', label: '七股区' },
          { value: '830522', label: '将军区' },
          { value: '830523', label: '学甲区' },
          { value: '830524', label: '北门区' },
          { value: '830525', label: '新营区' },
          { value: '830526', label: '后壁区' },
          { value: '830527', label: '白河区' },
          { value: '830528', label: '东山区' },
          { value: '830529', label: '六甲区' },
          { value: '830530', label: '下营区' },
          { value: '830531', label: '柳营区' },
          { value: '830532', label: '盐水区' },
          { value: '830533', label: '善化区' },
          { value: '830534', label: '大内区' },
          { value: '830535', label: '山上区' },
          { value: '830536', label: '新市区' },
      ...
      },
      {
        ...
        label: '高雄市',
        children: [
          { label: '楠梓区', value: '830601' },
          { value: '830602', label: '左营区' },
          { value: '830603', label: '鼓山区' },
          { value: '830604', label: '三民区' },
          { value: '830605', label: '盐埕区' },
          { value: '830606', label: '前金区' },
          { value: '830607', label: '新兴区' },
          { value: '830608', label: '苓雅区' },
          { value: '830609', label: '前镇区' },
          { value: '830610', label: '旗津区' },
          { value: '830611', label: '小港区' },
          { value: '830612', label: '凤山区' },
          { value: '830613', label: '大寮区' },
          { value: '830614', label: '鸟松区' },
          { value: '830615', label: '林园区' },
          { value: '830616', label: '仁武区' },
          { value: '830617', label: '大树区' },
          { value: '830618', label: '大社区' },
          { value: '830619', label: '冈山区' },
          { value: '830620', label: '路竹区' },
          { value: '830621', label: '桥头区' },
          { value: '830622', label: '梓官区' },
          { value: '830623', label: '弥陀区' },
          { value: '830624', label: '永安区' },
          { value: '830625', label: '燕巢区' },
          { value: '830626', label: '阿莲区' },
          { value: '830627', label: '茄萣区' },
          { value: '830628', label: '湖内区' },
          { value: '830629', label: '旗山区' },
          { value: '830630', label: '美浓区' },
          { value: '830631', label: '内门区' },
          { value: '830632', label: '杉林区' },
          { value: '830633', label: '甲仙区' },
          { value: '830634', label: '六龟区' },
          { value: '830635', label: '茂林区' },
          { value: '830636', label: '桃源区' },
      ...
      },
      {
        ...
        label: '基隆市',
        children: [
          { label: '中正区', value: '830701' },
          { value: '830702', label: '七堵区' },
          { value: '830703', label: '暖暖区' },
          { value: '830704', label: '仁爱区' },
          { value: '830705', label: '中山区' },
          { value: '830706', label: '安乐区' },
      ...
      },
      {
        ...
        label: '新竹市',
        children: [
          { label: '东区', value: '830801' },
          { value: '830802', label: '北区' },
          { value: '830803', label: '香山区' },
        ],
      },
      {
        value: '830900',
        label: '嘉义市',
        children: [
          { label: '东区', value: '830901' },
          { value: '830902', label: '西区' },
        ],
      },
    ],
  },
